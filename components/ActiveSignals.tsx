        ...
        <table className="w-full text-left border-collapse">
          <thead className="sticky top-0 bg-terminal-card z-10 text-[9px] text-gray-500 font-medium uppercase tracking-wider">
            <tr>
              ...
              <th className="px-2 py-1 border-b border-terminal-border">Action</th>
            </tr>
          </thead>
          <tbody className="text-[10px] font-mono divide-y divide-terminal-border">
            {safeSignals.map((signal) => (
              <tr 
                key={signal.id} 
                className="group hover:bg-terminal-card transition-colors cursor-pointer"
              ...
              >
                ...
                <td className="px-2 py-1 text-right">
                   <button
                      className="opacity-0 group-hover:opacity-100 transition-opacity text-[9px] bg-terminal-card hover:bg-blue-500/20 text-blue-400 px-1.5 py-0.5 rounded-sm border border-transparent hover:border-blue-500/30 flex items-center gap-1 ml-auto"
                   >
                      <Play size={8} /> LOAD
                   </button>
                </td>
